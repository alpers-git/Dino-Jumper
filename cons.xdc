...
set_property PACKAGE_PIN T18 [get_ports right]						
...
set_property PACKAGE_PIN U17 [get_ports left]						
	set_property IOSTANDARD LVCMOS33 [get_ports left]

## Switches
set_property PACKAGE_PIN V17 [get_ports {displayHighScore}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {displayHighScore}]
